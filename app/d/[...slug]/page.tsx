...
// Doctor-app Play Store deep link. Package is com.odudoc.doctor — the
// earlier rename to com.saluent.doctor was reverted when the brand
// re-consolidated on OduDoc.
