      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-6 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <Link href="/dashboard/doctor" className="rounded-lg p-2 text-gray-400 dark:text-slate-500 dark:text-slate-400 hover:bg-gray-100 dark:bg-slate-800 hover:text-gray-600 dark:text-slate-300">
          ...
          <button onClick={load} className="rounded-lg border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-2 text-sm font-medium text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:bg-slate-900">
            Refresh
          </button>
        </div>
            ...
            <div className="overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-sm">
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
                  {bookings.map((b) => (
                    <tr key={b.id} className="hover:bg-gray-50 dark:bg-slate-900">
