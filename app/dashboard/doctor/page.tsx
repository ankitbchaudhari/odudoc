            ...
            <Card>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { label: "My Clinics", href: "/dashboard/doctor/clinic", icon: "🏥", bg: "from-rose-100 to-pink-100 dark:from-rose-900/40 dark:to-pink-900/40", ring: "ring-rose-200 dark:ring-rose-800/60" },
                  { label: "Statements", href: "/dashboard/doctor/statements", icon: "🧾", bg: "from-cyan-100 to-blue-100 dark:from-cyan-900/40 dark:to-blue-900/40", ring: "ring-cyan-200 dark:ring-cyan-800/60" },
