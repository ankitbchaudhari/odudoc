        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm md:col-span-1">
                  ...
                  {([5, 4, 3, 2, 1] as const).map((star) => {
                    ...
                    return (
                      <div key={star} className="flex items-center gap-3 text-sm">
                        <span className="flex w-12 items-center gap-1 text-gray-600">
                          {star}
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <select
                ...
                className="rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20"
              >
          ...
          <div className="rounded-xl border border-dashed border-gray-200 bg-white p-16 text-center">
            ...
            <h2 className="text-base font-semibold text-gray-900">No reviews yet</h2>
