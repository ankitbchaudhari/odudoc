...
export default function PatientPrescriptionsPage() {
  ...
  if (status === "loading") {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 p-8 text-sm text-gray-400 dark:text-slate-500 dark:text-slate-400">
        Loading…
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {loading ? (
          <div className="rounded-xl border border-gray-100 bg-white dark:bg-slate-900 p-12 text-center text-sm text-gray-400 dark:text-slate-500 dark:text-slate-400">
            Loading…
          </div>
        ) : items.length === 0 ? (
