...
export default function ReferDoctorPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">Refer your doctor</h1>
      ...
      {done ? (
        <div className="mt-8 rounded-2xl border border-emerald-200 bg-emerald-50 p-6 text-center">
          ...
          <div className="mt-5 flex flex-col items-center gap-2 sm:flex-row sm:justify-center">
            <button
              onClick={reset}
              className="rounded-xl border border-emerald-300 bg-white dark:bg-slate-900 px-4 py-2 text-sm font-semibold text-emerald-800 hover:bg-emerald-100"
            >
        ...
        <form onSubmit={submit} className="mt-8 space-y-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
          {error && (
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Field label="Specialty">
              <select
                ...
                className="w-full rounded-lg border border-slate-300 bg-white dark:bg-slate-900 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              >
