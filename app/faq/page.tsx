      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-300 py-3 pl-12 pr-4 text-sm outline-none transition focus:border-primary-500 focus:ring-1 focus:ring-primary-500"
            />
          </div>
        </div>
        ...
        <div className="mt-8 space-y-3">
          {filteredFaqs.length === 0 ? (
            <p className="py-12 text-center text-gray-500">No FAQs found matching your search.</p>
          ) : (
        ...
        {/* CTA */}
        <div className="mt-16 rounded-xl bg-white p-8 text-center shadow-md">
