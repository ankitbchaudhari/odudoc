      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-purple-50 to-fuchsia-50 px-4 pb-20 pt-20">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/doctors"
              className="rounded-xl border-2 border-gray-300 bg-white/70 px-8 py-3.5 text-sm font-bold text-gray-800 backdrop-blur-sm transition-colors hover:border-indigo-400 hover:bg-white"
            >
              Browse Doctors
            </Link>
          </div>
        ...
        <div className="relative mx-auto max-w-3xl">
            ...
            <div className="rounded-[calc(1.5rem-2px)] bg-white p-6 md:p-8">
              ...
              <div className="mb-6">
                <label className="mb-2 block text-sm font-semibold text-gray-800">
                  ...
                  <span className="font-normal text-gray-500">(PDF, PNG, JPG — optional)</span>
                </label>
                <div
                  ...
                  className={`flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed px-6 py-10 transition-all ${
                    dragOver
                      ...
                      : "border-gray-300 bg-gradient-to-br from-slate-50 to-indigo-50/40 hover:border-indigo-400 hover:bg-indigo-50/60"
                  }`}
                >
                  <input
                    ref={fileRef}
                  ...
                  {file ? (
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="ml-2 rounded-lg p-1 text-gray-400 hover:bg-rose-100 hover:text-rose-600"
                      >
                    ...
                    <>
                      ...
                      <p className="mt-1 text-xs text-gray-500">Blood tests, X-ray reports, prescriptions, lab results (max 10MB)</p>
                    </>
                  )}
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-400 transition-colors focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
                />
                <p className="mt-1 text-right text-xs text-gray-400">{symptoms.length} / 1000</p>
              </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {SAMPLE_SYMPTOMS.map((s) => (
                    <button
                      ...
                      className="rounded-full border border-gray-200 bg-white px-3 py-1 text-xs text-gray-700 transition-all hover:border-indigo-400 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-fuchsia-50 hover:text-indigo-700"
                    >
          ...
          {loading && (
            <div className="mt-8 rounded-3xl border border-gray-100 bg-white p-8 text-center shadow-sm">
              ...
              <p className="font-semibold text-gray-900">Ray is analyzing your medical data…</p>
              <div className="mt-3 space-y-2">
                {["Reading report content", "Identifying conditions", "Matching specialist doctors"].map((step, i) => (
                  <p key={step} className="text-sm text-gray-500" style={{ animationDelay: `${i * 0.5}s` }}>
                    ✓ {step}
                  </p>
                ))}
              </div>
            ...
            <div ref={resultRef} className="mt-8 space-y-5">
              ...
              <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:shadow-lg">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <h2 className="font-bold text-gray-900">Ray&apos;s Analysis Summary</h2>
                </div>
                <p className="leading-relaxed text-gray-700">{result.summary}</p>

                {/* Detected conditions */}
                <div className="mt-4">
                  <p className="mb-2 text-xs font-bold uppercase tracking-wider text-gray-500">Possible Conditions Identified</p>
                  <div className="flex flex-wrap gap-2">
              ...
              <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
                <div className="mb-5 flex items-center gap-3">
                  ...
                  <h2 className="font-bold text-gray-900">Recommended Doctors</h2>
                </div>

                {result.recommendedDoctors.length === 0 ? (
                  <p className="text-sm text-gray-500">No specific doctors found. Please browse our <Link href="/doctors" className="font-semibold text-indigo-600 underline">full directory</Link>.</p>
                ) : (
                  <div className="grid gap-4 sm:grid-cols-2">
                    {result.recommendedDoctors.map((doc) => (
                      <div key={doc.id} className="flex flex-col justify-between rounded-2xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-0.5 text-xs text-gray-500">{doc.qualifications}</p>
              ...
              <div className="text-center">
                <button
                  ...
                  className="rounded-xl border-2 border-gray-200 bg-white px-6 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:border-indigo-400 hover:text-indigo-700"
                >
                  Start New Analysis
                </button>
              </div>
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-rose-50 via-white to-amber-50 px-4 py-20">
          ...
          <div className="relative mx-auto max-w-5xl">
            <div className="mb-14 text-center">
              ...
              <p className="mt-3 text-gray-500">Three simple steps to find your specialist.</p>
            </div>
            <div className="grid gap-6 md:grid-cols-3">
              {[
                ...
                <div key={item.step} className="rounded-3xl border border-gray-100 bg-white p-6 text-center shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-indigo-700 via-purple-700 to-fuchsia-700 py-20">
          ...
          <div className="relative mx-auto max-w-3xl px-4 text-center">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <a
                href="#try-ray"
                className="rounded-xl bg-white px-8 py-3.5 text-sm font-bold text-indigo-700 shadow-lg transition-all hover:scale-105"
              >
                ✨ Try Ray Now →
              </a>
              <Link
