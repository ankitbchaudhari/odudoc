...
export default function ShopPage() {
  ...
  const FilterSidebar = () => (
    <div className="space-y-6">
      {/* Categories */}
      <div>
        <h3 className="mb-3 text-sm font-semibold text-gray-900 dark:text-slate-100">Categories</h3>
      ...
      {/* Price Range */}
      <div>
        <h3 className="mb-3 text-sm font-semibold text-gray-900 dark:text-slate-100">Price Range</h3>
        <div className="px-1">
          <input
            type="range"
            min={1}
      ...
      {/* Rating */}
      <div>
        <h3 className="mb-3 text-sm font-semibold text-gray-900 dark:text-slate-100">Rating</h3>
        <div className="space-y-2">
          {[
      ...
      <div>
        ...
        <label className="flex cursor-pointer items-center gap-2 rounded-lg px-3 py-2 text-sm text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800">
          <input
            ...
            className="h-4 w-4 rounded border-gray-300 dark:border-slate-700 text-primary-600 focus:ring-primary-500"
          />
          In Stock Only
        </label>
      </div>
          ...
          <div className="mx-auto mt-8 max-w-xl">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border-0 py-3.5 pl-12 pr-4 text-gray-900 dark:text-slate-100 shadow-lg placeholder:text-gray-400 dark:text-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-300"
              />
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="rounded-lg border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 py-2 text-sm text-gray-700 dark:text-slate-300 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
            >
        ...
        <div className="flex gap-8">
          ...
          <aside className="hidden w-64 shrink-0 lg:block">
            <div className="sticky top-24 rounded-xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5">
              <h2 className="mb-4 text-base font-bold text-gray-900 dark:text-slate-100">Filters</h2>
              <FilterSidebar />
            </div>
          </aside>
          ...
          <div className="flex-1">
            {loading ? (
              <div className="rounded-xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-16 text-center text-sm text-gray-400 dark:text-slate-500">
                Loading products…
              </div>
              ...
              <div className="rounded-xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-16 text-center">
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-slate-100">No products found</h3>
              ...
              <>
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
                  {paginatedProducts.map((product) => (
                    <div
                      key={product.id}
                      className="group relative overflow-hidden rounded-xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
                    >
                      ...
                      <div className="p-4">
                        <Link href={`/shop/${product.id}`}>
                          <h3 className="font-semibold text-gray-900 dark:text-slate-100 transition-colors group-hover:text-primary-600">
                            {product.name}
                          </h3>
                        </Link>
                        {product.vendorName && (
                          <p className="mt-0.5 text-xs text-gray-400 dark:text-slate-500">
                            by {product.vendorId ? (
                              <Link href={`/shop/vendor/${product.vendorId}`} className="text-gray-500 dark:text-slate-400 hover:text-primary-600 hover:underline">
                                {product.vendorName}
                              </Link>
                            ) : product.vendorName}
                          </p>
