    ...
    <div className="bg-gray-50 py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="rounded-xl bg-white p-6 text-center shadow-sm">
            ...
            <div className="mt-1 flex justify-center gap-0.5">
              {Array.from({ length: 5 }).map((_, i) => (
                <svg key={i} className={`h-4 w-4 ${i < 5 ? "text-yellow-400" : "text-gray-200"}`} fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="rounded-xl bg-white p-6 text-center shadow-sm">
            <p className="text-3xl font-bold text-primary-600">2,700+</p>
        ...
        <div className="mt-16 rounded-xl bg-white p-8 shadow-md">
          ...
          {submitted ? (
            <div className="mt-8 flex flex-col items-center py-8 text-center">
              ...
              <p className="mt-2 text-gray-500">Your review has been submitted and will be published shortly.</p>
              ...
              <div>
                ...
                <div className="flex gap-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                      <svg
                        className={`h-8 w-8 transition-colors ${star <= formData.rating ? "text-yellow-400" : "text-gray-300"}`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
