          ...
          {article.whenToSeeDoctor && article.whenToSeeDoctor.length > 0 && (
            <div className="mt-8 rounded-2xl border border-red-100 bg-red-50/60 p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <Link
                  href="/doctors"
                  className="rounded-lg border border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-900 px-4 py-2 text-xs font-semibold text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800"
                >
                  Browse doctors
                </Link>
              </div>
