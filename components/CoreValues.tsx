const values = [
  ...
  },
  {
    ...
    title: "Innovation",
    description: "We embrace cutting-edge technology and research to advance healthcare solutions.",
  ...
  },
  {
    ...
    title: "Integrity",
    description: "We uphold honesty and transparency in everything we do, building trust with our patients.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="section-subtitle mx-auto max-w-2xl">
            The principles that guide everything we do at OduDoc
          </p>
        </div>
