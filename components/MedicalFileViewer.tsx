    ...
    <figure className={`overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm ${className}`}>
      <header className="flex items-center justify-between gap-3 border-b border-slate-100 bg-slate-50/60 px-4 py-2.5 text-xs">
        <div className="flex items-center gap-2 truncate">
          ...
          <span className="truncate font-semibold text-slate-800">{filename || "file"}</span>
        </div>
        <div className="flex items-center gap-2 text-slate-500">
          ...
          <a
            ...
            className="rounded-md border border-slate-200 bg-white px-2 py-0.5 font-semibold text-slate-700 hover:bg-slate-100"
          >
            Download
          </a>
        </div>
      ...
      {kind === "pdf" && (
        <iframe
          ...
          className="h-[70vh] w-full bg-slate-100"
        />
      )}
...
function Hint({
  ...
  return (
    <div className="flex flex-col items-center gap-3 p-12 text-center">
      ...
      <p className="max-w-md text-xs text-slate-500">{body}</p>
      {cta && (
        <a
          href={cta.href}
