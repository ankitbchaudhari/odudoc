    ...
    <div className="rounded-xl bg-gradient-to-br from-primary-600 to-teal-500 p-6 text-white">
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="mt-4">
          ...
          <button
            type="submit"
            className="mt-3 w-full rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-primary-600 shadow-sm transition-all hover:bg-gray-50 hover:shadow-md"
          >
            Subscribe
          </button>
        </form>
