const features = [
  {
    ...
    description: "Board-certified physicians with extensive experience across all medical specialties.",
    icon: (
  ...
  },
  {
    ...
    description: "State-of-the-art diagnostic and treatment equipment for precise medical care.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    <section className="bg-gray-50 dark:bg-slate-900 py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          {/* Image */}
          <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-primary-100 to-teal-100">
            <div className="flex h-[420px] items-center justify-center">
              <svg className="h-36 w-36 text-primary-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={0.5}>
