...
// Spec v6.3 / Final Cowork Reference Part C4: the platform sells in
// four B2B tiers, not consumer health plans. Patient consultations are
// always free; the subscription pays for the platform itself. Prices
// shown in USD with India-equivalent INR in description text.
export const pricingPlans: PricingPlan[] = [
  {
    ...
    monthlyPrice: 49,
    annualPrice: 490,
    description: "Solo doctor or single OPD. ≈ ₹4,000/mo. Everything you need to start practising online.",
    features: [
      { text: "1 doctor account", included: true },
      { text: "Unlimited patients", included: true },
      { text: "50 telemedicine consults / month", included: true },
      { text: "Basic AI prescription assist", included: true },
      { text: "Digital prescriptions + Rx PDF", included: true },
      { text: "Email support", included: true },
      { text: "Voice prescription (5 languages)", included: false },
      { text: "Multi-doctor / multi-clinic", included: false },
      { text: "Hospital admin panel (11 groups)", included: false },
      { text: "Inpatient + OT + ICU modules", included: false },
      { text: "Dedicated CSM + SLA", included: false },
    ],
    popular: false,
    cta: "Get started",
  },
  {
    ...
    monthlyPrice: 149,
    annualPrice: 1490,
    description: "Small clinic up to 10 staff. ≈ ₹12,000/mo. OPD-only, in-clinic pharmacy, TPA cashless.",
    features: [
      { text: "Up to 10 staff (reception + manager + doctors)", included: true },
      { text: "Unlimited consultations + video", included: true },
      { text: "OPD queue + token printer", included: true },
      { text: "In-clinic pharmacy + dispense", included: true },
      { text: "TPA empanelment + cashless claims", included: true },
      { text: "Voice prescription (5 languages)", included: true },
      { text: "GST invoices + statements", included: true },
      { text: "Lab orders + result PDFs", included: true },
      { text: "Hospital admin panel (11 groups)", included: false },
      { text: "Inpatient + OT + ICU modules", included: false },
      { text: "Dedicated CSM + SLA", included: false },
    ],
  ...
  },
  {
    ...
    monthlyPrice: 499,
    annualPrice: 4990,
    description: "Hospitals + multi-branch chains. ≈ ₹40,000/mo. Full 11-group admin panel, 150+ modules.",
    features: [
      { text: "Everything in Clinic Pro", included: true },
      { text: "Unlimited staff + doctors", included: true },
      { text: "Full 11-group admin panel", included: true },
      { text: "OPD + IPD + OT + ICU + ER", included: true },
      { text: "IV MAR + Code Blue + DNR registry", included: true },
      { text: "Pharmacy: 7 store classes + narcotic register", included: true },
      { text: "Radiology + PACS integration", included: true },
      { text: "NABH / JCI compliance tracker", included: true },
      { text: "Multi-branch / chain rollup", included: true },
      { text: "Ambient AI scribe + 5-language voice Rx", included: true },
      { text: "Dedicated CSM + SLA", included: false },
    ],
    popular: false,
    cta: "Get started",
  },
  {
    ...
    monthlyPrice: 0,
    annualPrice: 0,
    description: "Pharma supply chain, insurance company, hospital chains 50+ sites. Custom pricing.",
    features: [
      { text: "Everything in Hospital", included: true },
      { text: "Custom AI credit pool + pricing override", included: true },
      { text: "White-label + custom domain", included: true },
      { text: "ABDM / DHIS / FHIR integrations", included: true },
      { text: "Anti-counterfeit chain (pharma)", included: true },
      { text: "Marketplace listing (insurance)", included: true },
      { text: "Dedicated CSM + 99.9% SLA", included: true },
      { text: "Data residency + private cloud option", included: true },
