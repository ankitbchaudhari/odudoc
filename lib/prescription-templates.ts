...
export const PRESCRIPTION_TEMPLATES: PrescriptionTemplate[] = [
  ...
  },
  {
    ...
    description: "Warm orange-to-pink gradient header. Vibrant and welcoming.",
    style: "colorful",
    accentColor: "#F97316",
    previewBg: "#FFF7ED",
  },
  {
    id: "midnight-navy",
    name: "Midnight Navy",
    description: "Deep midnight blue with cyan accents — executive and serene.",
    style: "professional",
    accentColor: "#0F172A",
    previewBg: "#F1F5F9",
  },
  {
    id: "soft-pastel",
    name: "Soft Pastel",
    description: "Muted pastel palette — gentle and easy on the eyes.",
    style: "minimal",
    accentColor: "#A78BFA",
    previewBg: "#FAF5FF",
  },
  {
    id: "clinical-grid",
    name: "Clinical Grid",
    description: "Precision grid layout for maximum clarity and data density.",
    style: "professional",
    accentColor: "#0D9488",
    previewBg: "#F0FDFA",
  },
  {
    id: "bold-contrast",
    name: "Bold Contrast",
    description: "Strong black-and-red with large typography. Bold and modern.",
    style: "modern",
    accentColor: "#DC2626",
    previewBg: "#FEF2F2",
  },
  {
    id: "eco-green",
    name: "Eco Green",
    description: "Earthy olive-green theme with leaf motifs — holistic medicine feel.",
    style: "colorful",
    accentColor: "#65A30D",
    previewBg: "#F7FEE7",
  },
  {
    id: "crimson-red",
    name: "Crimson Red",
    description: "Deep crimson header with gold trim. Confident and premium.",
    style: "classic",
    accentColor: "#B91C1C",
    previewBg: "#FEF2F2",
  },
  {
    id: "sky-breeze",
    name: "Sky Breeze",
    description: "Airy sky-blue layout with cloud-like soft shadows. Calming.",
    style: "minimal",
    accentColor: "#0284C7",
    previewBg: "#F0F9FF",
  },
...
export const SAMPLE_PRESCRIPTION: PrescriptionData = {
  ...
  clinicEmail: "support@odudoc.com",
